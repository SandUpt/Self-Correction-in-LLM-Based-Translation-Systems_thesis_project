...
LOG_FILE_OUT="$LOG_DIR/5_preparation_self_correction_data_end_${TS}.log"
LOG_FILE_ERR="$LOG_DIR/5_preparation_self_correction_data_end_${TS}.err"
...
python3 5_preparation_self_correction_data_end.py
